...
(function() {
  var css = [
    ...
    "    --emojiOpacity: 0.75;",
    '    --version: "WhatsApp by Mew v1.4.8";',
    '    --message: "Updated on 21st of July. Small update to address a few GitHub issues. ";',
    ...
    "",
    "  /* Message bubbles. */",
    "  .message-out:not(.a81-s), .message {",
    "    background-color: var(--myMessage) !important; }",
    "    ._2v02G {",
    "      color: var(--lighter) !important; }",
    "",
    "    /* Message text color. */",
    ...
    "    .quoted-mention,",
    "    ._1upWv {",
    "      color: var(--myMessageText) !important; }",
    "",
    "    /* Voice messages. */",
    ...
    "",
    "      /* Message meta text color. */",
    '      [class*="message-out"] div > div:last-child span {',
    "        color: var(--icon); }",
    "",
    ...
    "    height: 10px !important;",
    "    z-index: 0 !important;",
    "    border-top: 12px solid var(--myMessage);",
    "    background: none !important; }",
    "    .tail.message-in .tail-container {",
    "      left: -10px !important; top: 0px;",
    "      border-left: 10px solid transparent;",
    ...
    "    fill: rgba(250,189,47, 0.8) !important; }",
    "    /* Audio length bar. */",
    "    ._22cMG.fS1bA .nDKsM {",
    "      background-color: var(--accent) !important; }",
    "      /* Slider thumb. */",
